...
const defaultApiOrigin = 'https://wheat-processes-raymond-template.trycloudflare.com';
const defaultFrontendOrigin = 'https://nearly-flood-cakes-native.trycloudflare.com';
